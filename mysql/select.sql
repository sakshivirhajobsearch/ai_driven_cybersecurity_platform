-- =====================================================
-- File: select.sql
-- Purpose: Common queries for monitoring & dashboard
-- =====================================================
...
WHERE severity_level='Critical' AND handled=FALSE;
...
WHERE executed_at < NOW() - INTERVAL 2 HOUR AND synced=FALSE;
...
SELECT model_name, AVG(action_taken) FROM ai_model_logs GROUP BY model_name;
